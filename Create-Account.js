...
const createdAccountAddress=document.getElementById("createdAccountAddress");
const createdAccountKey=document.getElementById("createdAccountKey");
const createdAccountIndex=document.getElementById("createdAccountIndex");
const newAccount=mainWallet.add(web3.eth.accounts.create());
...
logOut.addEventListener("click", walletLogout);
      createdAccountAddress.value=newAccount.address;
      createdAccountKey.value=newAccount.privateKey;
      createdAccountIndex.value=newAccount.index;
