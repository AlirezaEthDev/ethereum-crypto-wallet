...
const gateways= new Map();
      gateways.set("Ethereum Mainnet", "wss://mainnet.infura.io/ws/v3/57574a72c7bb464dbf287dfadeb940ae");
      gateways.set("Ropsten (Test Network)","wss://ropsten.infura.io/ws/v3/57574a72c7bb464dbf287dfadeb940ae");
      gateways.set("Rinkeby (Test Network)", "wss://rinkeby.infura.io/ws/v3/57574a72c7bb464dbf287dfadeb940ae");
      gateways.set("Kovan (Test Network)", "wss://kovan.infura.io/ws/v3/57574a72c7bb464dbf287dfadeb940ae");
      gateways.set("Goerli (Test Network)","wss://goerli.infura.io/ws/v3/57574a72c7bb464dbf287dfadeb940ae");
const web3=new Web3(new Web3.providers.WebsocketProvider(gateways.get("Ropsten (Test Network)")));
...
const networkPointer=document.getElementById("networkPointer");
...
//Setting balance and nonce of the default account:
   ...
   logOut.addEventListener("click", walletLogout);
    networkPointer.addEventListener("change", function(){networkSetting(networkPointer.value)});
        ...
        try{
         ...
         function gotoDeleteAccount(){
                ...
                function gotoSendTransaction(){
                    ...
                    function networkSetting(network){
                        networkTable.style.visibility="visible";
                        networkName.innerHTML=network;
                        try{
                                if(web3.setProvider(gateways.get(network))){
                                        web3.eth.getChainId().then(function(ChainID){
                                        detailsData[0].innerHTML=ChainID;
                                        detailsData[1].innerHTML=web3.currentProvider.url;
                                        web3.eth.getProtocolVersion().then(function(version){
                                            detailsData[2].innerHTML=parseInt(version,16);
                                            detailsData[3].innerHTML=web3.eth.defaultHardfork;
                                            web3.eth.getGasPrice().then(function(gasPrice){
                                                detailsData[4].innerHTML=web3.utils.fromWei(gasPrice)+" ETH";
                                            });
                                        });
                                    });
                            }else{
                                throw "The given network can not be set.\nMaybe, The provider is invalid!"
                            }
                    }catch(error){
