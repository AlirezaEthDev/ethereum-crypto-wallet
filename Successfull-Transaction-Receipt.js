...
const txStatusValue=document.getElementById("txStatusValue");
const blockHashValue=document.getElementById("blockHashValue");
const blockNumberValue=document.getElementById("blockNumberValue");
const transactionHashValue=document.getElementById("transactionHashValue");
const transactionIndexValue=document.getElementById("transactionIndexValue");
const fromValue=document.getElementById("fromValue");
const toValue=document.getElementById("toValue");
const valueValue=document.getElementById("valueValue");
const gasUsedValue=document.getElementById("gasUsedValue");
...
logOut.addEventListener("click", walletLogout);
      moreDetails.addEventListener("click", function(){window.location.href=networkToEtherscan.get(localStorage.getItem("network"))+localStorage.getItem("transactionHash")});
      txStatusValue.textContent=localStorage.getItem("status");
      blockHashValue.textContent=localStorage.getItem("blockHash");
      blockNumberValue.textContent=localStorage.getItem("blockNumber");
      transactionHashValue.textContent=localStorage.getItem("transactionHash");
      transactionIndexValue.textContent=localStorage.getItem("transactionIndex");
      fromValue.textContent=localStorage.getItem("from");
      toValue.textContent=localStorage.getItem("to");
      valueValue.textContent=localStorage.getItem("value");
      gasUsedValue.textContent=localStorage.getItem("gasUsed");
      gasPriceValue.textContent=localStorage.getItem("gasPrice");
      totalCostValue.textContent=localStorage.getItem("totalCost");
