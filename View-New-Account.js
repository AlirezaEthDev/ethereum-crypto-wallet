...
const addedAccountAddress=document.getElementById("addedAccountAddress");
const addedAccountKey=document.getElementById("addedAccountKey");
const addedAccountIndex=document.getElementById("addedAccountIndex");
const addedAccountBalance=document.getElementById("addedAccountBalance");
const addedAccountNonce=document.getElementById("addedAccountNonce");
...
logOut.addEventListener("click", walletLogout);
      addedAccountAddress.value=mainWallet[mainWallet.length-1].address;
      addedAccountKey.value=mainWallet[mainWallet.length-1].privateKey;
      addedAccountIndex.value=mainWallet[mainWallet.length-1].index;
      web3.eth.getBalance(addedAccountAddress.value).then(function(data){addedAccountBalance.value=web3.utils.fromWei(data)});
      web3.eth.getTransactionCount(addedAccountAddress.value).then(function(data){addedAccountNonce.value=data});
